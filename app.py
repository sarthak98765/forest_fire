...
def main_prediction():
    ...
    day = st.text_input("Day", "e.g. for Monday enter 1")
    ffmc = st.text_input("FFMC", "e.g. 91.7")
    dmc = st.text_input("DMC", "e.g. 26.2")
    dc = st.text_input("DC", "e.g. 77.5")
    isi = st.text_input("ISI", "e.g. 12.3")
    temp = st.text_input("Temp", "e.g. 14.6")
    rh = st.text_input("RH", "e.g. 30")
    wind = st.text_input("Wind", "e.g. 5.4")
    rain = st.text_input("Rain", "e.g. 0.8")
...
html_img = """<center><img src="https://innotech.kiet.edu/assets/innotechheaderfinalcopy-64009db9.png" width="210px"></center>"""
